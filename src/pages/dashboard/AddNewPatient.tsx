...
import { ArrowLeft, UserPlus, Users, Calendar, AlertCircle, Mail, Check } from "lucide-react";
      ...
      <div className="space-y-6 max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Register a new patient in the CareConnect system</p>
          </div>
        </div>
