...
export const doctorController = {
    createStaff: async (req, res) => {
        try {
            ...
            // Create user account
            await pool.query('INSERT INTO users (id, email, password_hash, first_name, last_name, role, phone, status) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [userId, email, hashedPassword, firstName, lastName, role, phone, 'active']);
            // If role is doctor, create doctor profile
            if (role === 'doctor') {
                await pool.query('INSERT INTO doctors (id, user_id, specialization) VALUES ($1, $2, $3)', [doctorId, userId, specialization || 'General Medicine']);
            }
...
export const patientController = {
    ...
    registerPatient: async (req, res) => {
        try {
            ...
            await pool.query('INSERT INTO users (id, email, password_hash, first_name, last_name, role, phone, status) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [userId, email, hashedPassword, firstName, lastName, 'patient', phone, 'active']);
            // Create patient profile
            await pool.query('INSERT INTO patients (id, user_id, date_of_birth, gender) VALUES ($1, $2, $3, $4)', [patientId, userId, dateOfBirth || null, gender || null]);
...
export const prescriptionController = {
    ...
    create: async (req, res) => {
        try {
            ...
            const prescription = await prescriptionModel.create(patientId, doctor.id, medicationName, dosage, frequency, duration || '30 days', instructions || '');
